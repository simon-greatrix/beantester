...
public interface BalanceData {
  ...
  private static boolean hasAmount(LabelledAmount dto) {
   ...
   */
  default BigDecimal getBalance(TypeLabel type) {
  ...
  default BigDecimal getBalance(String label) {
    List<LabelledAmount> balances = getBalances();
    for (LabelledAmount dto : balances) {
  ...
  @Nonnull
  List<LabelledAmount> getBalances();
   ...
   */
  default boolean has(TypeLabel type) {
