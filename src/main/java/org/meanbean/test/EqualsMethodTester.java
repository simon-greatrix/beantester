...
public class EqualsMethodTester {
   ...
   * </p>
   *
   * @param clazz                   The type to test the equals logic of.
   ...
   *                                example, "lastName".
   *
   * @throws IllegalArgumentException If either the specified clazz or insignificantProperties are deemed illegal. For example, if either
   ...
   * </p>
   *
   * @param factory                 An EquivalentFactory that creates non-null logically equivalent objects that will be used to test
