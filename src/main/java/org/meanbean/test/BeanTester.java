...
public class BeanTester {
  ...
  BeanTester(
      RandomValueGenerator randomValueGenerator, FactoryCollection factoryCollection,
   ...
   * </p>
   *
   * @param beanClass           The type to be tested.
   * @param customConfiguration The custom Configuration to be used when testing the specified beanClass type. This Configuration is
   ...
   * @throws AssertionError           If the bean fails the test.
   ...
   * </p>
   *
   * @param beanInformation Information about the type to be tested.
   * @param configuration   The custom Configuration to be used when testing the specified beanClass type. If no custom
   *                        Configuration is required, pass <code>null</code> or use <code>testBean(Class&lt;?&gt;)</code> instead.
   *
   * @throws IllegalArgumentException If the beanInformation is deemed illegal. For example, if it is null.
   * @throws AssertionError           If the bean fails the test.
   * @throws BeanTestException        If an unexpected exception occurs during testing.
   */
  protected void testBean(BeanInformation beanInformation, Configuration configuration)
    ...
    List<PropertyInformation> readableWritableProperties = PropertyInformationFilter.filter(
