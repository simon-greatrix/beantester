...
public class Configuration {
  ...
  static Function<Class<?>, Configuration> customConfigurationProvider(
      Map<Class<?>, Configuration> customConfigurations,
   ...
   * @param ignoredProperties Any properties of a type that should not be tested. Contains property names.
   * @param overrideFactories Factories that should be used for specific properties, overriding standard Factory selection.
   */
  Configuration(
      Integer iterations, Set<String> ignoredProperties, Map<String, Factory<?>> overrideFactories,
