...
public class HashCodeMethodTester {
   ...
   *
   * @throws IllegalArgumentException If the specified factory is deemed illegal. For example, if it is <code>null</code> or if it creates
   ...
   *
   * @throws IllegalArgumentException If the specified factory is deemed illegal. For example, if it is <code>null</code>, if it creates a
   ...
   *
   * @throws IllegalArgumentException If the specified clazz is deemed illegal. For example, if it is <code>null</code>.
   * @throws AssertionError           If the test fails.
   */
