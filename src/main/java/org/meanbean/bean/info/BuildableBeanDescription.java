...
class BuildableBeanDescription {
  ...
  BuildableBeanDescription(SerializableFunction0<?> builderFactory, SerializableFunction1<?, ?> beanFactory) {
  ...
  public BuildableBeanDescription setToBuilder(SerializableFunction1<?, ?> toBuilder) {
