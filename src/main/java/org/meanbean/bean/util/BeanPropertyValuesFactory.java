...
public class BeanPropertyValuesFactory implements Factory<Map<String, Object>> {
   ...
   *
   * @param beanInformation       Information used to create property values for a bean.
   * @param factoryLookupStrategy Provides a means of acquiring a suitable Factory for use when creating values.
   * @param configuration         Provides override configuration
   *
   * @throws IllegalArgumentException If the specified BeanInformation or FactoryLookupStrategy is deemed illegal. For example, if either
   *                                  is <code>null</code>.
   */
   ...
   *
   * @throws ObjectCreationException If an error occurs when creating the map of values.
   */
  @Override
