...
public class BasicBeanPopulator implements BeanPopulator {
   ...
   */
  @Override
  public Object populate(Object bean, BeanInformation beanInformation, Map<String, Object> values)
    ...
    for (PropertyInformation property : writableProperties) {
      ...
      if (values.containsKey(propertyName)) {
        try {
          bean = property.getWriteMethod().invoke(bean, values.get(propertyName));
        } catch (Exception e) {
          String message =
